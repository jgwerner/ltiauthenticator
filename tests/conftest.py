...
def lti11_complete_launch_args():
    ...
    args = {
        ...
        'launch_presentation_return_url': [
            'https: //canvas.instructure.com/courses/161/external_content/success/external_tool_redirect'.encode()
        ],
...
def lti13_auth_params():
    ...
    redirect_uri = 'https://jupyterhub.acme.com/hub/oauth_callback'
    lti_message_hint = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..uYHinkiAT5H6EkZW9D7HJ1efoCmRpy3Id-gojZHlUaA'
    login_hint = '185d6c59731a553009ca9b59ca3a885104ecb4ad'
...
def lti13_auth_params_dict(lti13_auth_params):
    ...
    """
    args = convert_request_to_dict(lti13_auth_params)
    return args
...
def lti13_login_params_dict(lti13_login_params):
    ...
    Return the initial LTI 1.3 authorization request as a dict
    """
    args = convert_request_to_dict(lti13_login_params)
    return args
...
def make_lti13_resource_link_request() -> Dict[str, str]:
    ...
    jws = {
        ...
        'https://purl.imsglobal.org/spec/lti/claim/launch_presentation': {
            ...
            'height': 400,
            'width': 800,
            'return_url': 'https://canvas.instructure.com/courses/147/external_content/success/external_tool_redirect',
            'locale': 'en',
            'validation_context': None,
            'errors': {'errors': {}},
        },
        ...
        'https://purl.imsglobal.org/spec/lti-ags/claim/endpoint': {
            ...
            'lineitems': 'https://canvas.instructure.com/api/lti/courses/147/line_items',
            'validation_context': None,
            'errors': {'errors': {}},
        },
        ...
        'https://purl.imsglobal.org/spec/lti-nrps/claim/namesroleservice': {
            'context_memberships_url': 'https://canvas.instructure.com/api/lti/courses/147/names_and_roles',
            'service_versions': [
                '2.0',
            ],  # noqa: E231
            'validation_context': None,
...
def make_lti13_resource_link_request_privacy_enabled() -> Dict[str, str]:
    ...
    jws = {
        ...
        'https://purl.imsglobal.org/spec/lti-ags/claim/endpoint': {
            ...
            'lineitems': 'https://canvas.instructure.com/api/lti/courses/169/line_items',
            'validation_context': None,
            'errors': {'errors': {}},
        },
        ...
        'sub': '8171934b-f5e2-4f4e-bdbd-6d798615b93e',
        'https://purl.imsglobal.org/spec/lti/claim/target_link_uri': 'https://test.acme.com/',
        'https://purl.imsglobal.org/spec/lti/claim/context': {
            'id': '41c4731cc7668aef2eddeeb99132ba6239d8e058',
            'label': 'intro101',
            'title': 'intro101',
        ...
        'https://purl.imsglobal.org/spec/lti/claim/launch_presentation': {
            ...
            'height': 400,
            'width': 800,
            'return_url': 'https://acme.instructure.com/courses/169/external_content/success/external_tool_redirect',
            'locale': 'en',
            'validation_context': None,
            'errors': {'errors': {}},
        },
        ...
        'https://purl.imsglobal.org/spec/lti-nrps/claim/namesroleservice': {
            'context_memberships_url': 'https://canvas.instructure.com/api/lti/courses/169/names_and_roles',
