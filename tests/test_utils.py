...
from ltiauthenticator.lti13.utils import user_is_a_student
from ltiauthenticator.lti13.utils import user_is_an_instructor
...
def test_normalize_string_return_false_with_missing_name():
    ...
    with pytest.raises(ValueError):
        normalize_string(container_name)
...
def test_normalize_string_with_long_name():
    ...
    normalized_container_name = normalize_string(container_name)
